...
export default function FixedAssetsTable({ datas, currentPage, perPage }: MasterDataTableProps) {
      ...
      <AlertDialog open={deleteId !== null} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. This will permanently delete this fixed asset and remove
