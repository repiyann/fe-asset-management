...
import FixedAssetsTable from './table'
...
export default async function FixedAssets({ searchParams }: { searchParams: SearchParams }) {
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        <Card x-chunk="dashboard-06-chunk-0">
            ...
            <div className="ml-auto flex items-center gap-2">
              ...
              <Button size="sm" className="h-7 gap-1">
                ...
                <span className="sr-only sm:not-sr-only sm:whitespace-nowrap">
                  <a href="/dashboard/fixed-assets/create">Add Fixed Asset</a>
                </span>
              </Button>
            </div>
          </div>
          {datas.length !== 0 ? (
            <>
              <CardContent>
                <FixedAssetsTable datas={datas} currentPage={page} perPage={pageMetadata.perPage} />
              </CardContent>
              <CardFooter className="flex justify-between items-center">
                <div className="text-xs text-muted-foreground">
                  ...
                  of <strong>{pageMetadata.total}</strong> fixed assets
                </div>
